...
By accessing or using Aither ("the Software"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Software.
...
- You must comply with all applicable laws regarding content you process
...
- The Software uses client-side authentication with SHA-256 hashing
- This is NOT production-grade security
- For sensitive or production use, implement additional security measures
...
- Locally stored data remains in your browser (you may delete it)

## 11. Export Compliance

You agree to comply with all applicable export and import control laws and regulations in your use of the Software.
